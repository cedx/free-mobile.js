...
class Client extends EventEmitter {
  ...
  async sendMessage(text) {
    if (!this.username.length || !this.password.length) throw new ClientError('The account credentials are invalid.');

    let message = text.trim();
    if (!message.length) throw new ClientError('The specified message is empty.');
