...
task('test:config', () => writeFile('test/config.g.js', [
  '/**', ' * The Free Mobile username.', ' * @type {string}', ' */',
  `export const username = '${process.env.FREEMOBILE_USERNAME}';`, '',
  '/**', ' * The Free Mobile password.', ' * @type {string}', ' */',
  `export const password = '${process.env.FREEMOBILE_PASSWORD}';`, ''
].join(EOL)));
